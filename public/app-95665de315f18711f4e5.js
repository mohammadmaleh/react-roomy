...
var baseUrl =  true ? '/' : 'http://localhost:3000';
...
function configureStore() {
    ...
    return new Promise(function (resolve, reject) {
        try {
            var store = (0, _redux.createStore)(reducer, undefined, (0, _redux.compose)((0, _reduxPersist.autoRehydrate)(), _redux.applyMiddleware.apply(undefined, middlewares), window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__()));
...
//# sourceMappingURL=app-95665de315f18711f4e5.js.map