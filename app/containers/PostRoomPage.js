                    ...
                    <div className="column large-9" >
                        ...
                        <div className="row">
                            ...
                            <div className="column large-3">
                                ...
                                <input  type="number" name="capacity" ref='capacity' onChange={this.handleFormChange}/>
                            </div>
                            <div className="column large-3 float-left">
                                <label htmlFor="size">size</label>
                                <input  type="number" name="size" ref='size' onChange={this.handleFormChange}/>
                            </div>
